				...
				<div className='max-w-7xl mx-auto'>
					...
					<motion.div
						...
						<p className='text-gray-600 dark:text-gray-400'>
							Current standings for all Special FC teams
						</p>
					</motion.div>
									...
									.map((team, index) => {
										...
										return (
											<motion.div
												...
												className={`grid grid-cols-12 gap-4 p-4 hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors ${getPositionColor(
													position,
												)}`}>
												{/* Position */}
