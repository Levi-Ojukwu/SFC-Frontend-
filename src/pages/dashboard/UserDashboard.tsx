...
import { Trophy, Target, AlertTriangle, Calendar, CreditCard, CheckCircle, XCircle, TrendingUp, Users, Award } from 'lucide-react'
...
interface DashboardData {
  ...
  is_verified: boolean
  recent_matches: Match[] // Use the new Match interface
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Team Position</p>
                  <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">#{dashboardData.team_position}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Cards</p>
                  <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                    <span className="text-yellow-500">{dashboardData.statistics.yellow_cards}</span>
                    <span className="text-gray-400 mx-1">/</span>
                    <span className="text-red-500">{dashboardData.statistics.red_cards}</span>
                  </p>
                </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <motion.div
                ...
                className="card p-6"
              >
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Team Information</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Team Name</p>
                    <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">
                      {dashboardData.user.team?.name || "Not Assigned"}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Position in Table</p>
                    <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Monthly Dues (₦1,000)</h2>
                  <Link to="/payment" className="btn-primary px-4 py-2 text-sm">
                    Make Payment
                  </Link>
                </div>
                ...
                {dashboardData.payment_status ? (
                  <div>
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 mb-4">
                      <div
                        className={`h-3 rounded-full transition-all duration-300 ${getProgressColor(dashboardData.payment_status.progress_percentage)}`}
                        style={{ width: `${dashboardData.payment_status.progress_percentage}%` }}
                      ></div>
                    </div>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">Last Payment</p>
                        <p className="font-medium text-gray-900 dark:text-gray-100">
                          {new Date(dashboardData.payment_status.payment_date).toLocaleDateString()}
                        </p>
                      </div>
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">Expires</p>
                        <p className="font-medium text-gray-900 dark:text-gray-100">
                          {new Date(dashboardData.payment_status.expiry_date).toLocaleDateString()}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-4">No payment records found</p>
              ...
              >
                ...
                {dashboardData.recent_matches.length > 0 ? (
                  <div className="space-y-4">
                    {dashboardData.recent_matches.slice(0, 3).map((match, index) => (
                      <div
                        key={index}
                      ...
                      >
                        <div className="flex items-center space-x-4">
                          <div className="text-center">
                            <p className="font-medium text-gray-900 dark:text-gray-100">{match.homeTeam?.name || 'N/A'}</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">vs</p>
                            <p className="font-medium text-gray-900 dark:text-gray-100">{match.awayTeam?.name || 'N/A'}</p>
                          </div>
                        </div>
                        <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-center py-8">No recent matches found</p>
                )}
              </motion.div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <motion.div
                ...
                className="card p-6"
              >
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Your Statistics</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Goals</span>
                    <span className="font-bold text-gray-900 dark:text-gray-100">{dashboardData.statistics.goals}</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-yellow-500">{dashboardData.statistics.yellow_cards}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Red Cards</span>
                    <span className="font-bold text-red-500">{dashboardData.statistics.red_cards}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Handballs</span>
                    <span className="font-bold text-gray-900 dark:text-gray-100">
